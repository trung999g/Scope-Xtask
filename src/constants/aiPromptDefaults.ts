...
/**
 * Gemini 2.5 Flash-Lite: multimodal, tối ưu throughput/chi phí — hợp đọc mô tả, phân loại, JSON.
 * (gemini-2.0-flash-lite đã deprecated theo Google; dễ 429 hơn khi endpoint cũ.)
 *
 * Nếu vẫn 429: tăng VITE_AI_GLOBAL_GAP_MS, tắt VITE_AI_AUTO_SCORE, hoặc bật billing.
 */
...
Nếu FRAUD hoặc USELESS → finalScore PHẢI = 0.`,
  ...
  jsonOutputContract: `Trả về ĐÚNG một mảng JSON, không markdown. Trường "id" khớp payload.
Mỗi phần tử:
{
